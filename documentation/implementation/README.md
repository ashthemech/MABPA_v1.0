...
* **Brake Actuation**: The servo connects to the brake lever via [a ball joint and "hook" interface](https://github.com/ashthemech/MABPA/blob/main/documentation/implementation/MABPA%20Servo%20Mount%20and%20Connection.jpg) secured by a hose clamp.
